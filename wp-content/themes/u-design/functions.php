...
function udesign_init_styles() {
	...
	wp_enqueue_style('u-design-style', get_bloginfo('template_url') . "/styles/style1/css/style.css", false, '2.3.1', 'screen');
        ...
        if ( get_theme_mod( 'udesign_custom_styles_use_css_file' ) ) { // load "custom_style.css" file
            ...
            wp_enqueue_style('u-design-custom-style', get_bloginfo('template_url') . '/styles/custom/custom_style.css', false, '2.3.1'.$rand_ver, 'screen');
        } else { // otherwise use "custom_style.php" file
            wp_enqueue_style('u-design-custom-style', get_bloginfo('template_url') . '/styles/custom/custom_style.php', false, '2.3.1', 'screen');
        }
        
        if ( $udesign_responsive ) {
            wp_enqueue_style('u-design-responsive', get_bloginfo('template_url') . '/styles/common-css/responsive.css', false, '2.3.1', 'screen');
        }
        if ( $udesign_options['max_theme_width'] || $udesign_options['global_theme_width'] > 960 || 
            ...
            wp_enqueue_style('u-design-fluid', get_bloginfo('template_url') . '/styles/common-css/fluid.css', false, '2.3.1', 'screen');
        }
        
        if ( $udesign_options['enable_default_style_css'] ) {
            wp_enqueue_style('u-design-style-orig', get_stylesheet_directory_uri() . "/style.css", false, '2.3.1', 'screen');
        }
    }
}
